	...
	if request.method == 'GET':
		if DEBUG == 0:
			...
			# Form table
				...
				tablerow["chi_a"] = str(row0[2]) 
				tablerow["chi_b"] = str(row0[3]) 
				tablerow["chi_c"] = str(row0[4])
				tablerow["method"] = str(row0[5])
                    ...
                    pass
        tablecontent = [{"polymer" : "something", "chi_a" : "aa", "chi_b":  "bb", "chi_c" : "cc", "method" : "method somehting"},
                            {"polymer" : "something 22", "chi_a" : "aa", "chi_b":  "bb", "chi_c" : "cc", "method" : "method somehting"},
                            {"polymer" : "something 33", "chi_a" : "aa", "chi_b":  "bb", "chi_c" : "cc", "method" : "method somehting"}]
	print tablecontent
        return Response(json.dumps(tablecontent),  mimetype='application/json')
        #return jsonify(**tablecontent)
